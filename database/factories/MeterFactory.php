...
class MeterFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'name' => fake()->unique()->bothify('MTR-####'),
            'default_name' => fake()->bothify('MTR-####'),
            'type' => fake()->randomElement(['ION6200', 'PM8000', 'PM5500']),
            'brand' => fake()->randomElement(['Schneider', 'ABB', 'Siemens']),
            'role' => fake()->randomElement(['Main', 'Sub', 'Check', 'Client Meter']),
            'customer_name' => fake()->company(),
            'multiplier' => fake()->randomElement([1, 10, 100, 1000]),
            'status' => 'Active',
            'last_log_update' => now(),
        ];
    }
